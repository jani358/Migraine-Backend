...
export interface ApiCommitmentCommitment extends Struct.CollectionTypeSchema {
  collectionName: 'commitments';
  info: {
    description: "Feature cards \u2014 'Personalized Medical Plans', 'Airport Pickup', etc.";
    displayName: 'Commitment / Feature';
...
export interface ApiDoctorDoctor extends Struct.SingleTypeSchema {
  collectionName: 'doctors';
  info: {
    description: "The specialist \u2014 'Meet Your Specialist' section + the stats band.";
    displayName: 'Doctor';
    pluralName: 'doctors';
    singularName: 'doctor';
  };
  ...
  attributes: {
    ...
    introVideoUrl: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::doctor.doctor'
...
export interface ApiFaqFaq extends Struct.CollectionTypeSchema {
  collectionName: 'faqs';
  info: {
    description: 'Frequently asked questions \u2014 the FAQ accordion section.';
    displayName: 'FAQ';
    pluralName: 'faqs';
    singularName: 'faq';
  };
...
export interface ApiPricingPlanPricingPlan extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Treatment packages \u2014 the 'Choose Your Path to Relief' section.";
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ctaLabel: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Book Now'>;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global content \u2014 header, hero, contact details, footer, social links.';
  ...
  attributes: {
    ...
    copyright: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u00A9 2026 CEYLONHOSPITAL.COM - ALL RIGHTS RESERVED'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSymptomSymptom extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Checklist items \u2014 the 'Have You Experienced Any of These?' section.";
    displayName: 'Symptom';
    pluralName: 'symptoms';
...
export interface ApiTextTestimonialTextTestimonial
  extends Struct.CollectionTypeSchema {
  collectionName: 'text_testimonials';
  info: {
    description: "Written patient reviews \u2014 the 'What Our Clients Say' section.";
    displayName: 'Text Testimonial';
    pluralName: 'text-testimonials';
    singularName: 'text-testimonial';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiVideoTestimonialVideoTestimonial
  ...
  info: {
    description: "Patient video stories \u2014 the 'Real Stories. Real Patients.' section.";
